...
} from "../../../data/controllers/backlogController"; // ← CORREGIDO
  ...
  return (
    <div className={styles.modalBacklog}>
      <div className={styles.modalContentBacklog}>
        ...
        />
        {errores.descripcion && <p className={styles.modalError}>{errores.descripcion}</p>}
        ...
        <div className={styles.modalButtonGroup}>
          <button className={styles.modalCancelButtonBacklog} onClick={closeModal}>
            Cancelar
          </button>
          <button
